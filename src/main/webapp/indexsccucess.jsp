...
<div class="mainNav">
    <div class="Nav_inner clearfix w1200center">
        ...
        <ul class="nav_tab" id="mainTab">
            ...
            <li class="hasSubMenu">
                <a href="QueryServlet?action=remain">我的账户</a>
                <div class="subMenu">
                    <div class="subMenu_inner">
                        <a href="QueryServlet?action=remain">我的账户</a>
                    </div>
            ...
            <li class="hasSubMenu">
                ...
                <div class="subMenu">
                    <div class="subMenu_inner">
                        <a href="help.jsp" target="_blank">客服大厅</a>
            ...
            <li class="hasSubMenu">
                <a href="UsersServlet?action=logout">注销</a>
            </li>
        </ul>
    ...
    <div class="part_info" style="position:relative;">
        ...
        <div class="index_description clearfix">
            <div class="no1">
                <div class="no1">
                    <div class="des_head">
                        <div class="head_inner_left"><p class="texttitle">70,162,291</p><p class="textnum">人发现并注册拍拍贷</p></div>
                        <div class="head_inner_right">
                            <p class="texttitle">38,500,852</p><p class="textnum">笔成功借款</p>
                            <p class="texttitle">10,316,373.17万 </p><p class="textnum">累计成交总额</p>
                        </div>
                    </div>
...
<script type='text/javascript'>
    ...
    (function () {
        ...
        {
            _vds.push(['setCS1', 'user_name', 'pdu7517155657']);
        }
        (function () {
...
</html>ww.ppdaicdn.com/2014/js/init.js" type="text/javascript" charset="utf-8"></script>
