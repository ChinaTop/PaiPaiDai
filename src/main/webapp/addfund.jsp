...
<aside class="Hui-aside">
    ...
    <div class="menu_dropdown bk_2">
        ...
        <dl id="menu-product">
            ...
            <dd>
                <ul>
                    <li><a _href="FundServlet?action=display" href="javascript:void(0)">基金管理</a></li>
                </ul>
            </dd>
        </dl>
        <!--<dl id="menu-page">
    ...
    <div class="container">
        <form action="AdminServlet" method="post" name="f">
            ...
            <div class="form-group">
                <label class="col-form-label" for="name">基金名:</label>
                <input id="name"  name="name" class="form-control" type="text">
            </div>

            <div class="form-group">
                <label class="col-form-label" for="risklevel">风险等级:</label>
            ...
            <div class="form-group">
                <label class="col-form-label" for="rate">利率:</label>
                <input type="text" id="rate" name="rate" class="form-control">
            </div>

            <div class="form-group">
                <label class="col-form-label" for="investamount">投资金额:</label>
                <input type="text" id="investamount" name="investamount" class="form-control">
            </div>

            <div class="form-group">
                <label class="col-form-label" for="investdate">上架日期:</label>
                <input type="date" id="investdate" name="investdate" class="form-control">
            </div>

            <div class="form-group">
                <label class="col-form-label" for="deadline">期限:</label>
                <input type="text" id="deadline" name="deadline" class="form-control">
            </div>

            <div class="form-group">
                <label class="col-form-label" for="investman">投资人数:</label>
                <input id="investman" name="investman" readonly class="form-control" type="text" value="0">
            </div>

            <div class="form-group">
                <label class="col-form-label" for="ifdisplay">状态:</label>
                <input type="text"  value="1" readonly id="ifdisplay" class="form-control" name="ifdisplay">
            </div>
            <br><br>
            <div align="center">
