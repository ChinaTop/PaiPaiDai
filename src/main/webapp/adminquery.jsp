    ...
    <form action="AdminServlet" method="post" name="f">
        <div class="my-f-right fr">
            ...
            <table cellpadding="0" cellspacing="0" class="receivetab c666666">
                <thead>
                <tr>
                    <td><a href="AdminServlet?action=list&pageno=${pageno}&pagesize=${pagesize}&sort=querydate&order=asc">日期</a></td>
                    <td><a href="AdminServlet?action=list&pageno=${pageno}&pagesize=${pagesize}&sort=username&order=asc">用户</a></td>
                    <td><a href="AdminServlet?action=list&pageno=${pageno}&pagesize=${pagesize}&sort=querytype&order=asc">类型</a></td>
                    <td><a href="AdminServlet?action=list&pageno=${pageno}&pagesize=${pagesize}&sort=userexpenditure&order=asc">支出</a></td>
                    <td><a href="AdminServlet?action=list&pageno=${pageno}&pagesize=${pagesize}&sort=userdeposit&order=asc">存入</a></td>
                    <td><a href="AdminServlet?action=list&pageno=${pageno}&pagesize=${pagesize}&sort=remaining&order=asc">余额</a></td>
                    <td width="200">说明</td>
                </tr>
                </thead>
                <tbody>
                ...
                <tr>
                    <td colspan="5">
                        ...
                        <a href="AdminServlet?action=list&username=${username}&time=${time}&pageno=1&pagesize=${pagesize}&sort=${sort}&order=${order}">首页</a>
                        &nbsp;&nbsp;
                        <a href="AdminServlet?action=list&username=${username}&time=${time}&pageno=${pageno-1}&pagesize=${pagesize}&sort=${sort}&order=${order}">上一页</a>
                        &nbsp;&nbsp;
                        <a href="AdminServlet?action=list&username=${username}&time=${time}&pageno=${pageno+1}&pagesize=${pagesize}&sort=${sort}&order=${order}">下一页</a>
                        &nbsp;&nbsp;
                        <a href="AdminServlet?action=list&username=${username}&time=${time}&pageno=${maxpage}&pagesize=${pagesize}&sort=${sort}&order=${order}">尾页</a>
                        &nbsp;&nbsp;
...
<script type="text/javascript">
    ...
    function cargo() {
        ...
        location.href = "AdminServlet?action=list&username=${username}&time=${time}&pageno=" + pageno + "&pagesize=" + pagesize + "&sort=${sort}&order=${order}"
    }
