...
<section class="Hui-article-box">
    <div id="Hui-tabNav" class="Hui-tabNav">
        <div class="Hui-tabNav-wp">
            <ul id="min_title_list" class="acrossTab cl">
                <li class="active"><span title="我的桌面" data-href="welcome.html">贷款审批</span><em></em></li>
            </ul>
        </div>
    ...
    <div class="container">
    <form action="AdminServlet?action=gothrough" method="post" name="f">
        <input type="hidden" name="loanid" value="${requestScope.loanid}">
        <div class="form-group">
            <label class="col-form-label" for="username">用户名:</label>
            <input id="username"  readonly name="username" class="form-control" type="text"  value="${requestScope.username}">
        </div>

        <div class="form-group">
            <label class="col-form-label" for="loanamount">借款金额:</label>
            <input id="loanamount" readonly name="loanamount" class="form-control"  type="text" value="${requestScope.loanamount}">
        </div>

        <div class="form-group">
            <label class="col-form-label" for="loandate">借款日期:</label>
            <input type="text" readonly id="loandate" name="loandate" class="form-control" value="${requestScope.datestr}">
        </div>

        <div class="form-group">
            <label class="col-form-label" for="loantime">借款期限:</label>
            <%--<input type="text" name="loantime" id="loantime" class="form-control"  value="30">--%>
            <input id="loantime" name="loantime" readonly class="form-control" type="text" value="${requestScope.loantime}">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text"  value="${requestScope.repayment}" readonly id="repayment" class="form-control" name="repayment">
        </div>

        <div align="center">
            <img src="${requestScope.usernameurl}" width="600px" height="400px" align="center">
        </div>
        <br><br>
        <div align="center">
        <button type="submit" class="btn btn-primary">审核通过</button>
            <button type="button" class="btn btn-primary" onclick="notthrough(${requestScope.loanid})">审核不通过</button>
        </div>
    </form>
    </div>
...
<script type="text/javascript">
    ...
    function notthrough(loanid){
        window.location.href="AdminServlet?action=notthrough&loanid="+loanid
    }
