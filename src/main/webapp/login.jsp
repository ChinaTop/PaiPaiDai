    ...
    <style type="text/css">
        *{
        ...
        body{
            font-family: "微软雅黑";
            font-size: 14px;
            background: url(1494318631621.jpg) fixed center center;
        }
        .logo_box{
            width: 280px;
            height: 490px;
...
<div class="logo_box">
    <h3>拍拍贷欢迎您</h3>
    <form action="UsersServlet" name="f" method="post">
        ...
        <div class="mb2"><input name="登录" type="submit" class="act-but submit " style="color: #FFFFFF " value="登录" ></div>
